...
void	render_weapon(t_data *data)
{
	...
	{
		mlx_put_image_to_window(data->mlx_connection, data->mlx_window, data->player->weapon[0].img_ptr, ((WIDTH - data->player->weapon[data->player->fire_frame].width) / 2) + 100, 400);
